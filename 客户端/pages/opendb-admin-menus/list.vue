<template>
  <view>
    ...
    <view class="uni-container">
      <unicloud-db ref="udb" :collection="collectionList" field="menu_id,name,icon,url,sort,parent_id,permission,enable,create_date" :where="where" page-data="replace"
        ...
        <uni-table ref="table" :loading="loading" :emptyText="error.message || '没有更多数据'" border stripe type="selection" @selection-change="selectionChange">
          <uni-tr>
            ...
            <uni-th align="center" filter-type="search" @filter-change="filterChange($event, 'url')" sortable @sort-change="sortChange($event, 'url')">url</uni-th>
            ...
            <uni-th align="center" sortable @sort-change="sortChange($event, 'permission')">permission</uni-th>
            <uni-th align="center" sortable @sort-change="sortChange($event, 'enable')">enable</uni-th>
...
<script>
  import { enumConverter, filterToWhere } from '../../js_sdk/validator/opendb-admin-menus.js';
  ...
  export default {
    data() {
      return {
        collectionList: "opendb-admin-menus",
        query: '',
        where: '',
        orderby: dbOrderBy,
        orderByFieldName: "",
        ...
        exportExcel: {
          "filename": "opendb-admin-menus.xls",
          "type": "xls",
          "fields": {
            "menu_id": "menu_id",
            "name": "name",
