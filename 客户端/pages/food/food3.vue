<template>
  <view class="container">
    ...
    <unicloud-db ref="udb" :where="judge" orderby="state asc" v-slot:default="{data, loading, error, options}" collection="guestbook3,uni-id-users,food" field="_id,test,state,score,time,user_id.nickname,user_id.avatar_file,user_id._id,textto._id,textto.rating,textto.comment_count">
	...
	export default {
		...
		methods: {
			...
			async send(itemId) {
			  ...
			  const guestbookTable = db.collection('guestbook3');
